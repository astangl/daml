...
import com.daml.ledger.resources.Context._
...
object JdbcIndexer {
  ...
  private[indexer] final class Factory(
    ...
    def validateSchema()(implicit context: Context): Future[ResourceOwner[JdbcIndexer]] =
    ...
    )(implicit context: Context): Future[ResourceOwner[JdbcIndexer]] =
      new FlywayMigrations(config.jdbcUrl)
    ...
    private def initializeLedger(dao: LedgerDao)(): ResourceOwner[Option[Offset]] =
      new ResourceOwner[Option[Offset]] {
        override def acquire()(implicit context: Context): Resource[Option[Offset]] =
    ...
    private def initOrCheckParticipantId(
        dao: LedgerDao,
    )(implicit context: Context): Future[Unit] = {
...
private[indexer] class JdbcIndexer private[indexer] (
  ...
  private class SubscriptionResourceOwner(
    ...
    override def acquire()(implicit context: Context): Resource[IndexFeedHandle] =
      Resource(Future {
